...
@property (nonatomic, strong) VideoSliderBubble *popoverBubble;
...
- (id)initWithFrame:(CGRect)frame videoUrl:(NSURL *)videoUrl{
    ...
    if (self) {
        ...
        _leftThumb = [[VideoSliderLeftView alloc] initWithFrame:CGRectMake(0, 0, thumbWidth, frame.size.height)];
        ...
        _rightThumb = [[VideoSliderRightView alloc] initWithFrame:CGRectMake(0, 0, thumbWidth, frame.size.height)];
        ...
        _popoverBubble = [[VideoSliderBubble alloc] initWithFrame:CGRectMake(0, -50, 100, 50)];
