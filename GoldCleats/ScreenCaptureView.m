...
- (void)saveToPhotoAlbumFromPath:(NSURL *)inputPath {
    ALAssetsLibrary *library = [[ALAssetsLibrary alloc] init];
    
    
    
    [library writeVideoAtPathToSavedPhotosAlbum:inputPath completionBlock:^(NSURL *assetURL, NSError *error){
        ...
        if (error) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^(){
                NSLog(@"saved video in library assetURL %@", assetURL);
            });
